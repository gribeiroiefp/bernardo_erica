...
$sql_livros = " SELECT livros.id_livro, livros.titulo, livros.ano, livros.capa,
                FROM livros JOIN filme_autor ON livros.id = livro_autor.id_livro
    ...
    <section class="box">
         <div class="row align-items-center">
            ...
            <div class="col-1 opcoes align-self-start">
                <a href="editAutor.php?id=<?php echo htmlspecialchars($autor['id_autor']) ?>" class="btn btn-primary btn-editar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
        ...
        <div class="lista col">
            ...
            if ($resultado_livros && mysqli_num_rows($resultado_livros) > 0)
                while ($livro = mysqli_fetch_assoc($resultado_livros)) {
                    ...
                    echo "<p>There are no books associated to this author!</p>";
                }
            ?>
        </div>
