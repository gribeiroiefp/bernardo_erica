...
$resultado = mysqli_query($conn, $sql_livro);
...
$autor = mysqli_fetch_assoc($resultado_autores);
    ...
    <section class="box">
        <div class="row align-items-center">
            ...
            <div class="col-1 opcoes align-self-start">
                <a href="editLivro.php?id=<?php echo htmlspecialchars($livro['id_livro']) ?>" class="btn btn-primary btn-editar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
        ...
        <div class="lista col">
            ...
            if ($resultado_autores && mysqli_num_rows($resultado_autores) > 0)
                while ($autor = mysqli_fetch_assoc($resultado_autores)) {
                    ...
                    echo "<p>There is no author associated to this book! <br> Please add an author in the edit page! </p>";
                }
            ?>
        </div>
